  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-bold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary: "bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-105 shadow-lg",
        laborer: "bg-laborer text-laborer-foreground hover:bg-laborer/90 hover:scale-105 shadow-lg",
        hirer: "bg-hirer text-hirer-foreground hover:bg-hirer/90 hover:scale-105 shadow-lg",
        success: "bg-success text-success-foreground hover:bg-success/90 hover:scale-105 shadow-lg",
        destructive:
